...
#include <google/protobuf/port_def.inc>
#define PROTOBUF_INTERNAL_EXPORT_satellite_2eproto

// Internal implementation detail -- do not use these members.
struct TableStruct_satellite_2eproto {
...
class GeneralStatus final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:GeneralStatus) */ {
 public:
  GeneralStatus();
  ...
  inline GeneralStatus* New() const final {
    return CreateMaybeMessage<GeneralStatus>(nullptr);
  }
 ...
 private:
  ...
  friend struct ::TableStruct_satellite_2eproto;
};
// -------------------------------------------------------------------
...
class ServiceInfo final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:ServiceInfo) */ {
 public:
  ServiceInfo();
  virtual ~ServiceInfo();
...
class GetCurrentVersionResponse final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:GetCurrentVersionResponse) */ {
 public:
  ...
  inline GetCurrentVersionResponse* New() const final {
    return CreateMaybeMessage<GetCurrentVersionResponse>(nullptr);
  }
...
class GetServiceNodesRequest final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:GetServiceNodesRequest) */ {
 public:
  ...
  inline GetServiceNodesRequest* New() const final {
    return CreateMaybeMessage<GetServiceNodesRequest>(nullptr);
  }
...
class GetServiceNodesResponse final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:GetServiceNodesResponse) */ {
 public:
  ...
  inline GetServiceNodesResponse* New() const final {
    return CreateMaybeMessage<GetServiceNodesResponse>(nullptr);
  }
...
class GetAllServiceNamesResponse final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:GetAllServiceNamesResponse) */ {
 public:
  ...
  inline GetAllServiceNamesResponse* New() const final {
    return CreateMaybeMessage<GetAllServiceNamesResponse>(nullptr);
  }
...
inline const ::ServiceInfo& HeartbeatRequest::service_info() const {
  ...
  return p != nullptr ? *p : *reinterpret_cast<const ::ServiceInfo*>(
      &::_ServiceInfo_default_instance_);
}
...
inline const ::GeneralStatus& GetServiceNodesResponse::status() const {
  ...
  return p != nullptr ? *p : *reinterpret_cast<const ::GeneralStatus*>(
      &::_GeneralStatus_default_instance_);
}
